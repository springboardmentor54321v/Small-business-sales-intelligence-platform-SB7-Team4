...
def load_business_overview_data(base_url, inventory_url, revenue_url):
...
def business_overview_page():
    ...
    with st.spinner("Loading Business Overview..."):
        try:
            sales_df, inventory_df, revenue = load_business_overview_data(BASE_URL, INVENTORY_API, REVENUE_API)
        except Exception:
            db_error = True
